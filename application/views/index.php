      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Cuentas</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
              <div class="btn-group mr-2">
                <button class="btn btn-secondary" onclick="showagregar()"> <i class="fas fa-plus-circle"></i> Agregar Cuenta</button>
              </div>
            </div>
          </div>
          <div class="container-fluid">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formcuenta" name="formcuenta">
            <div class="form-group">
                ...
                <select class="form-control" id="banco" name="banco" required>
                    ...
                    <?php
                        foreach ($banco as $fila ) {
                    ?>
                    <option value="<?= $fila->id ?>"><?= $fila->nombre_corto ?></option>
            ...
            <div class="form-group">
                <label >Alias</label>
                <div>
                    <input id="alias" name="alias" class="form-control" type="text" value="" required>
                </div>
            </div> 
            <div class="form-group">
                <label >Cuenta</label>
                <div>
                    <input id="cuenta" name="cuenta" class="form-control" type="text" value="" required>
                </div>
            </div> 
        </form>
      </div>
